...
| Phase | Scope | Status |
|---|---|---|
| **C0** | Per-format leaf-page header offsets across `Constants.IndexLeafPage`, `IndexLeafPageBuilder.LeafPageLayout`, `IndexBTreeBuilder`, `IndexLeafIncremental`, `IndexCursor`, `IndexPageCodec`, `AccessWriter.MaintainIndexesAsync`. | **Shipped 2026-05-02.** |
