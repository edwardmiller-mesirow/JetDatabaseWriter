...
- **Logical TDEF shrink can orphan old continuation pages.** Wide-TDEF drop/reclaim may shorten the reachable page chain. The old continuation pages are not inserted into a free-page bitmap; they are left for Compact & Repair, consistent with the index rebuild and old-LVAL-chain orphan model elsewhere in the writer.
