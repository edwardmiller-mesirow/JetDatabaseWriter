...
**C0 + C1 have shipped.** C2, C4, and C5 are now regression-guarded. C3 remains technical debt but is not gating for the covered writer-created table, relationship, complex-column, encrypted-output, Access-file linked-table, text linked-table, cached-schema ODBC, or generated ODBC catalog flows. DAO Compact & Repair succeeds for the DAO-compatible covered flows.
