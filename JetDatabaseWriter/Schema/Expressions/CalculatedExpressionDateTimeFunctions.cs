...
internal static class CalculatedExpressionDateTimeFunctions
{
    ...
    {
        AddFunction(functions, new CalculatedFunctionDescriptor(CalculatedFunctionDomain.DateTime, "DATE", 0, 0, static _ => DateTime.Today, "TODAY"));
        AddFunction(functions, new CalculatedFunctionDescriptor(CalculatedFunctionDomain.DateTime, "NOW", 0, 0, static _ => DateTime.Now));
        AddFunction(functions, new CalculatedFunctionDescriptor(CalculatedFunctionDomain.DateTime, "TIME", 0, 0, static _ => DateTime.Today + DateTime.Now.TimeOfDay));
        ...
        AddFunction(functions, new CalculatedFunctionDescriptor(CalculatedFunctionDomain.DateTime, "TIMEVALUE", 1, 1, static function => DateTime.Today + ToDateTime(function.Arg(0)).TimeOfDay));
        ...
        AddFunction(functions, new CalculatedFunctionDescriptor(CalculatedFunctionDomain.DateTime, "TIMER", 0, 0, static _ => DateTime.Now.TimeOfDay.TotalSeconds));
