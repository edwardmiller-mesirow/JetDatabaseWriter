...
| Phase | Scope | Status |
|---|---|---|
| **C0** | Per-format leaf-page header offsets across `Constants.IndexLeafPage`, `IndexPageLayout`, `IndexBTreeBuilder`, `IndexCursor`, `IndexPageCodec`, `IndexBTreeEditor`, and `AccessWriter.MaintainIndexesAsync`. | **Shipped 2026-05-02.** |
